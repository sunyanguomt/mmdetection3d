    ...
    setup(
        ...
        ext_modules=[
            ...
            make_musa_ext(
                ...
                sources_musa=['src/furthest_point_sample_cuda.cu']),
            make_musa_ext(
                name='gather_points_ext',
                module='mmdet3d.ops.gather_points',
                sources=['src/gather_points.cpp'],
                sources_musa=['src/gather_points_cuda.cu'])
        ],
